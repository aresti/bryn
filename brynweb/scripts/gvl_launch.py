...
"""
    ...
    userdata = (
        yaml.dump(user_specific_data, default_flow_style=False, allow_unicode=False)
        + yaml.dump(cloud_specific_data, default_flow_style=False, allow_unicode=False)
        + yaml.dump(
            yaml.load(generic_data), default_flow_style=False, allow_unicode=False
        )
    )
    ...
    volume = cinder.volumes.create(
        imageRef=tenant.region.regionsettings.gvl_image_id,
    ...
    # [{"boot_index": "0", "uuid": "c19be03e-07fb-4d43-8531-c0bc1f8500e6", "volume_size"
    # : "120", "source_type": "volume", "destination_type": "volume",
